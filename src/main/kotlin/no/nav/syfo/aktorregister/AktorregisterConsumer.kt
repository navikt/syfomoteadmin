...
class AktorregisterConsumer @Inject constructor(
    ...
    private fun getIdentFromAktorregister(ident: String, identType: IdentType): Map<String, IdentinfoListe> {
        ...
        try {
            ...
            metric.countEvent(METRIC_CALL_AKTORREGISTER_SUCCESS)
            return responseBody
        } catch (e: RestClientResponseException) {
            metric.countEvent(METRIC_CALL_AKTORREGISTER_FAIL)
    ...
    companion object {
        ...
        private const val METRIC_CALL_AKTORREGISTER_SUCCESS = "call_aktorregister_success"
        private const val METRIC_CALL_AKTORREGISTER_FAIL = "call_aktorregister_fail"
    }
}
