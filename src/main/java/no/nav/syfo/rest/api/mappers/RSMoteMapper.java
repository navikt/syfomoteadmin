...
import no.nav.syfo.rest.api.model.RSMotedeltaker;
import no.nav.syfo.rest.api.model.RSTidOgSted;

import java.time.LocalDateTime;
import java.util.List;
import java.util.function.Function;

import static no.nav.syfo.rest.api.model.RSReservasjon.KontaktInfoFeilAarsak.*;
