...
import no.nav.syfo.rest.api.model.RSMote;
import no.nav.syfo.rest.api.model.RSTilgang;
...
import static no.nav.syfo.rest.api.mappers.RSMoteMapper.mote2rs;
import static no.nav.syfo.rest.api.mappers.RSNyttMoteMapper.opprett2Mote;
import static no.nav.syfo.rest.api.mappers.RSNyttMoteMapper.opprett2TidOgSted;
