...
class JmsTestConfig {
    ...
    fun oppgaveHenvendelseQueue(): JmsTemplate {
        return JmsTemplateMock("oppgaveHenvendelseQueue")
    }

    @Bean(name = ["opprettVarselQueue"])
    fun opprettvarselqueue(): JmsTemplate {
        return JmsTemplateMock("opprettvarselqueue")
    }
