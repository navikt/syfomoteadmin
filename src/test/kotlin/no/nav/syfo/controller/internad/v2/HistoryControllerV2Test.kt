...
import no.nav.syfo.history.controller.v2.HistoryControllerV2
...
@DirtiesContext
class HistoryControllerV2Test : AbstractRessursTilgangTest() {
    ...
    @Inject
    private lateinit var historyController: HistoryControllerV2
