...
import no.nav.syfo.api.ressurser.azuread.v2.MoterActionsControllerV2
...
@DirtiesContext
class MoterActionsControllerV2Test : AbstractRessursTilgangTest() {
    @MockBean
    private lateinit var moteService: MoteService

    @Inject
    lateinit var moterActionsController: MoterActionsControllerV2
