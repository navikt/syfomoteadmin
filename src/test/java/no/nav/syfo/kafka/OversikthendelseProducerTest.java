...
public class OversikthendelseProducerTest {
    ...
    @Test
    public void sendOversikthendelseMoteplanleggerAlleSvarMottatt() {
        ...
        KOversikthendelse kOversikthendelse = KOversikthendelse.builder()
                ...
                .hendelseId(MOTEPLANLEGGER_ALLE_SVAR_MOTTATT.name())
                .enhetId(NAV_ENHET)
                .tidspunkt(now())
                .build();
    ...
    @Test
    public void sendOversikthendelseMoteplanleggerAlleSvarBehandlet() {
        when(kafkaTemplate.send(anyString(), anyString(), any(KOversikthendelse.class))).thenReturn(mock(ListenableFuture.class));

        KOversikthendelse kOversikthendelse = KOversikthendelse.builder()
                .fnr(ARBEIDSTAKER_FNR)
                .hendelseId(MOTEPLANLEGGER_ALLE_SVAR_BEHANDLET.name())
                .enhetId(NAV_ENHET)
                .tidspunkt(now())
                .build();
